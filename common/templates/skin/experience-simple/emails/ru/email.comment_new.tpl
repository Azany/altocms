...
оставил новый комментарий к посту <b>«{$oTopic->getTitle()|escape:'html'}»</b>,
...
{if $sSubscribeKey}
	<br><br>
	<a href="{router page='subscribe'}unsubscribe/{$sSubscribeKey}/">Отписаться от новых комментариев к этому посту</a>
{/if}
